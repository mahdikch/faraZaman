...
public class UserDefinedLayoutReader {
     ...
     * Constructor
     *
     * @param udl     User defined layout
     * @param c       Context for accessing resources
     * @param tl      TrackLogger activity
     * @param trackId Current track id
     * @param input   Parser for reading layout
     * @param ir      Icon resolver to use to fetch icons
     */
     ...
     *
     * @param layout {@link TableLayout} to rattach the row to
     * @throws XmlPullParserException
     * @throws IOException
     */
     ...
     * Inflates a <button>
     *
     * @param row The table row to attach the button to
     */
